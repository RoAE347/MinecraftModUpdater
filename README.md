...
3.  **Шлах до папки з модами**: Вставте повний шлях до папки, де знаходяться ваші поточні моди, і натисніть Enter.
4.  **Бажана версія**: Введіть версію, до якої ви хочете оновитися (наприклад, `1.21.1`).
5.  **Бажаний завантажувач**: Введіть `fabric` або `forge`.
